...
namespace TerraFX.Interop
{
    ...
    public unsafe partial struct IDirect3DCubeTexture9
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int GetCubeMapSurface(D3DCUBEMAP_FACES FaceType, [NativeTypeName("UINT")] uint Level, [NativeTypeName("IDirect3DSurface9 **")] IDirect3DSurface9** ppCubeMapSurface)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int LockRect(D3DCUBEMAP_FACES FaceType, [NativeTypeName("UINT")] uint Level, [NativeTypeName("D3DLOCKED_RECT *")] D3DLOCKED_RECT* pLockedRect, [NativeTypeName("const RECT *")] RECT* pRect, [NativeTypeName("DWORD")] uint Flags)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [return: NativeTypeName("HRESULT")]
        public int UnlockRect(D3DCUBEMAP_FACES FaceType, [NativeTypeName("UINT")] uint Level)
        {
