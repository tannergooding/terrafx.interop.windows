...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class IDirect3D9ExOverlayExtensionTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<IDirect3D9ExOverlayExtension>(), Is.EqualTo(sizeof(IDirect3D9ExOverlayExtension)));
        }
