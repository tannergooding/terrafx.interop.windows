...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class D3DDEVINFO_D3D9CACHEUTILIZATIONTests
    {
        /// <summary>Validates that the <see cref="D3DDEVINFO_D3D9CACHEUTILIZATION" /> struct is blittable.</summary>
        [Test]
        public static void IsBlittableTest()
        {
            Assert.That(Marshal.SizeOf<D3DDEVINFO_D3D9CACHEUTILIZATION>(), Is.EqualTo(sizeof(D3DDEVINFO_D3D9CACHEUTILIZATION)));
        }
